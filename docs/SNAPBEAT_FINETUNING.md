...
python snapbeat_inference.py \
  audio_path="song.mp3" \
  lora_path="luannnguyen/snapbeat-lora-v8" \
...
|------------|-----------|--------------|-----------|------------|-------|
| `luannnguyen/snapbeat-lora-v8` | **75.3%** | **85.7%** | **92.8%** | **69.6%** | **Best all metrics** — Run 8 (timing context in decoder) |
...
| `luannnguyen/snapbeat-lora-v5` | 64.6% | 85.0% | 91.3% | 67.9% | Run 5 (prior best timing) |
| `logs/2026-03-24/21-31-48/checkpoint-2001/lora` | 64.6% | 85.0% | 91.3% | 67.9% | Same as v5 (local path) |
...
Best checkpoint: `logs/2026-04-15/09-49-00/checkpoint-2001/lora` (hosted as `luannnguyen/snapbeat-lora-v8`).
